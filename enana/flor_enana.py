...
for angulo in petalos_capa2:
    ...
    petalo1(angulo)
    t.end_fill()
petalos_capa3=[350.43,78.47,137.49,193.74,264.44,41.44,112.74,112.74,168.29,236.28,307.56]
for angulo in petalos_capa3:
    go(0,0)
    t.begin_fill()
    petalo2(angulo)
    t.end_fill()
petalos_capa4=[3.29,59.45,125.24,176.54,247.16,312.27,24.57,93.79,152.34,214.16,276.63,340.03]
...
t.pencolor("#ffc414")
t.fillcolor("#e5e619")
petalos_capa4=[17.45,53.49,79.61,102.65,129.66,168.29,199.65,234.34,258.19,296.7,310.05,345.98]
for angulo in petalos_capa4:
    go(0,0)
    t.begin_fill()
    petalo4(angulo)
